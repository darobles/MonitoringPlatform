 ...
 * @author Marco
 */
public class CruceDocumentoTO implements Serializable {
    ...
    public String toString() {
        return "CruceDocumentoTO{" + "idDoc=" + idDoc + ", idCruce=" + idCruce + ", fecha=" + fecha + ", fechaDesc=" + fechaDesc + ", tipo=" + tipo + ", tipoDesc=" + tipoDesc + ", archivo=" + archivo + ", observacion=" + observacion + ", usrSub=" + usrSub + ", nombreArchivo=" + nombreArchivo + ", OT_AUTER=" + OT_AUTER + ", OTM=" + OTM + ", fecha_otm=" + fecha_otm + ", fec_rec_otm=" + fec_rec_otm + ", fec_medicion=" + fec_medicion + ", desc_medicion=" + desc_medicion + ", medicion=" + medicion + ", resultado=" + resultado + ", fec_ing_uoct=" + fec_ing_uoct + ", fec_apr_uoct=" + fec_apr_uoct + ", archivo2=" + archivo2 + ", archivo3=" + archivo3 + ", archivo4=" + archivo4 + ", archivo5=" + archivo5 + ", nombreArchivo2=" + nombreArchivo2 + ", nombreArchivo3=" + nombreArchivo3 + ", nombreArchivo4=" + nombreArchivo4 + ", nombreArchivo5=" + nombreArchivo5 + ", nombre_doc2=" + nombre_doc2 + ", nombre_doc3=" + nombre_doc3 + ", nombre_doc4=" + nombre_doc4 + ", nombre_doc5=" + nombre_doc5 + '}';
    }
